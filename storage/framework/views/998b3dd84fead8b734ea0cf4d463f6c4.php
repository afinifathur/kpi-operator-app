<div class="space-y-6">
        ...
        <div class="md:col-span-2">
            ...
            <select wire:model.defer="operator_id" class="w-full border rounded p-2">
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->operators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($op->id); ?>"><?php echo e($op->label); ?></option>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
        <div class="rounded border bg-white p-4">
            <div class="text-xs text-gray-500">Jumlah Operator</div>
            <div class="text-2xl font-semibold"><?php echo e($this->summary['operator']); ?></div>
        </div>
        <div class="rounded border bg-white p-4">
        ...
        <table class="min-w-full text-sm">
            ...
            <tbody>
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $this->rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <tr class="border-t">
                        <td class="p-2"><?php echo e($r->operator_label); ?></td>
                        <td class="p-2 text-right"><?php echo e((int) $r->jobs_count); ?></td>
                        <td class="p-2 text-right"><?php echo e(number_format($r->target_qty ?? 0)); ?></td>
                        <td class="p-2 text-right"><?php echo e(number_format($r->total_qty ?? 0)); ?></td>
                        <td class="p-2 text-right">
                            <span class="px-2 py-0.5 rounded <?php echo e($badge); ?>">
                                <?php echo e(number_format($r->pencapaian_pct ?? 0, 2)); ?>%
                            </span>
                        </td>
                    </tr>
...
<?php /**PATH C:\laragon\www\kpi-operator-app\resources\views/filament/pages/operator-scorecard-simple.blade.php ENDPATH**/ ?>